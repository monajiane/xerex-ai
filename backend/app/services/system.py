...
_MODULES: tuple[tuple[str, str, str, tuple[tuple[str, str, str], ...]], ...] = (
    ...
    (
        ...
        (
            ...
            ("POST", "/api/v1/routing-rules/simulate", "Dry-run a routing decision."),
        ),
    ),
    (
        "provider_health",
        ...
        "planned",
        (
            ("GET", "/api/v1/health-checks", "Health history per target."),
            ("POST", "/api/v1/health-checks/run", "Run a health check now."),
        ),
    ),
    (
        "usage",
        ...
        "planned",
        (
            ("GET", "/api/v1/usage/summary", "Aggregated usage and cost."),
    ...
    (
        ...
        "M6",
        "planned",
        (("GET", "/api/v1/logs", "Request log with request_id correlation."),),
    ),
)
