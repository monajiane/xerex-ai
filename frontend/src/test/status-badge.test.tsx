...
describe("StatusBadge", () => {
  it("renders the rate-limited health state in Persian with a warning tone", () => {
    render(<StatusBadge domain="healthStatus" value="rate_limited" />);
    const badge = screen.getByText("محدودشده با نرخ");
    expect(badge).toBeInTheDocument();
    expect(badge.closest("[class]")).toBeTruthy();
  });
