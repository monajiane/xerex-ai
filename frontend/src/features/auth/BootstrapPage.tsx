...
export function AuthGate() {
  const { bootstrapAllowed } = useAuth();
  // ``bootstrapAllowed`` is already "required and enabled"; when setup is disabled
  // on this deployment the sign-in screen is shown instead of a dead-end form.
  return bootstrapAllowed ? <BootstrapPage /> : <LoginPage />;
}
